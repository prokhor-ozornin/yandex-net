...
public static class IDetectorRequestExtensions
{
  ...
  extension(IDetectorRequest request)
  {
    /// <summary>
    ...
    public IDetectorRequest OperaMini(string version)
    {
    ...
    /// <returns>Back reference to the provided <paramref name="request"/> instance.</returns>
    /// <seealso cref="IDetectorRequest.WithHeader"/>
    public IDetectorRequest Profile(string profile)
    {
      if (request is null) throw new ArgumentNullException(nameof(request));
    ...
    /// <returns>Back reference to the provided <paramref name="request"/> instance.</returns>
    /// <seealso cref="IDetectorRequest.WithHeader"/>
    public IDetectorRequest UserAgent(string userAgent)
    {
      if (request is null) throw new ArgumentNullException(nameof(request));
